...
The password can simply be **1234**. It doesn't have to be that long.
</details>
...
<details>
<summary>Shadowsocks/SagerNet/Matsuri/NekoBox/husi/Exclave</summary>
...
AutoGuard app supports Android 5.0 (Lollipop) and above.

- [x] AdGuard v4.x support
- [x] AdGuard v3.x support (Legacy mode)
